    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-lifeway-pink shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-3">
          <a href={import.meta.env.VITE_MARKETING_URL || 'http://localhost:5175'}
            ...
            title="Back to Lifeway Programs">
            <HeartIcon />
          </a>
          <div>
            <a href={import.meta.env.VITE_MARKETING_URL || 'http://localhost:5175'}
              className="text-white font-bold text-xl leading-none hover:underline">
              Lifeway Programs
            </a>
